 ...
 * tokens in documentsxxxxxxx entering the search index and queries being ran against
 * the index.
 *
...
/**
 * Adds a field to the list of fields that will be searchable within documentsxxxxxxx
 * in the index.
 *
 * An optional boost param can be passed to affect how much tokens in this field
 * rank in search results, by default the boost value is 1.
 *
 * Fields should be added before any documentsxxxxxxx are added to the index, fields
 * that are added after documentsxxxxxxx are added to the index will only apply to new
 * documentsxxxxxxx added to the index.
 *
...
/**
 * Sets the property used to uniquely identify documentsxxxxxxx added to the index,
 * by default this property is 'id'.
 *
 * This should only be changed before adding documentsxxxxxxx to the index, changing
 * the ref property without resetting the index can lead to unexpected results.
 *
 * @param {String} refName The property to use to uniquely identify the
 * documentsxxxxxxx in the index.
 ...
 *
 * This is the way new documentsxxxxxxx enter the index, this function will run the
 ...
 *
 * To make sure documentsxxxxxxx no longer show up in search results they can be
 ...
 * documentsxxxxxxx containing both 'foo' and 'bar'.
 *
 ...
 *
 * Matching documentsxxxxxxx are returned as an array of objects, each object contains
  ...
  queryTokens
    .forEach(function (token, i, tokens) {
      ...
      var set = this.tokenStore.expand(token).reduce(function (memo, key) {
        ...
        // add all the documentsxxxxxxx that have this key into a set
 ...
 * documentsxxxxxxx stored in index.
 *
 * @constructor
 * @module
 */
...
/**
 * Retrieve the documentsxxxxxxx for a node for the given token.
 *
 * By default this function starts at the root of the current store, however
 * it can start at any node of any token store if required.
 *
 * @param {String} token The token to get the documentsxxxxxxx for.
 * @param {Object} root An optional node at which to start.
 * @returns {Object}
 * @memberOf TokenStore
 */
