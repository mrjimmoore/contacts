...
/**
 * The string version of this documentsxxxxxxx _id.
 *
 * ####Note:
 *
 * This getter exists on all documentsxxxxxxx by default. The getter can be disabled by setting the `id` [option](/docs/guide.html#id) of its `Schema` to false at construction time.
 *
 ...
 * ####Example
 *
 *     doc.set('documentsxxxxxxx.0.title', 'changed');
 *     doc.isModified()                    // true
 *     doc.isModified('documentsxxxxxxx')         // true
 *     doc.isModified('documentsxxxxxxx.0.title') // true
 *     doc.isDirectModified('documentsxxxxxxx')   // false
 *
 ...
 *
 *     doc.set('documentsxxxxxxx.0.title', 'changed');
 *     doc.isDirectModified('documentsxxxxxxx.0.title') // true
 *     doc.isDirectModified('documentsxxxxxxx') // false
 *
 * @param {String} path
 * @return {Boolean}
...
/**
 * Returns this documentsxxxxxxx dirty paths / vals.
 *
 * @api private
 * @method $__dirty
 * @memberOf Document
...
/**
 * Assigns/compiles `schema` into this documentsxxxxxxx prototype.
 *
 * @param {Schema} schema
 * @api private
 * @method $__setSchema
...
Document.prototype.toJSON = function (options) {
  // check for object type since an array of documentsxxxxxxx
  // being stringified passes array indexes instead
  // of options objects. JSON.stringify([doc, doc])
  // The second check here is to make sure that populated documentsxxxxxxx (or
