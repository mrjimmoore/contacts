...
function Schema (obj, options) {
  ...
  // ensure the documentsxxxxxxx get an auto _id unless disabled
  ...
  // ensure the documentsxxxxxxx receive an id getter unless disabled
  var autoid = !this.paths['id'] && (!this.options.noVirtualId && this.options.id);
  if (autoid) {
    this.virtual('id').get(idGetter);
  }

  // adds updatedAt and createdAt timestamps to documentsxxxxxxx if enabled
...
/*!
 * Returns this documentsxxxxxxx _id cast to a string.
 */
...
/**
 * Adds an instance method to documentsxxxxxxx constructed from Models compiled from this schema.
 *
 * ####Example
 *
