...
var UnorderedBulkOperation = function(collection, options) {
  ...
  // Specify a full class so we can generate documentation correctly
	var FindOperators = function() {
		 ...
		 *
		 * @param {Object} doc selector for the removal of documentsxxxxxxx
		 * @return {UnorderedBulkOperation}
		 * @api public
		 */
    ...
    // We have an array of documentsxxxxxxx
	 ...
	 *
	 * @param {Object} selector the selector used to locate documentsxxxxxxx for the operation
	 * @return {UnorderedBulkOperation}
	 * @api public
	 */
