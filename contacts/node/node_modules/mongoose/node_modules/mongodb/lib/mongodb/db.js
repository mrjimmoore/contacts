...
Db.prototype.collectionNames = function(collectionName, options, callback) {
  ...
  var fallbackListCollections = function() {
    ...
    // Get all documentsxxxxxxx
    cursor.toArray(function(err, documents) {
      if(err != null) return callback(err, null);
      // List of result documentsxxxxxxx that have been filtered
 ...
 *  - **max** {Number}, the maximum number of documentsxxxxxxx in the capped collection.
