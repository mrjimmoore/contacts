...
struct {
    ...
    int32     numberToSkip;           // number of documentsxxxxxxx to skip when returning results
    int32     numberToReturn;         // number of documentsxxxxxxx to return in the first OP_REPLY
...
QueryCommand.prototype.toBinary = function(bsonSettings) {
  ...
  // Write the number of documentsxxxxxxx to skip
  ...
  // Write the number of documentsxxxxxxx to return
