 ...
 *
 * Options
 *  - **skip** {Number} skip number of documentsxxxxxxx to skip.
 ...
 *  - **raw** {Boolean}, raw return all query documentsxxxxxxx as raw buffers (default false).
 ...
 *  - **exhaust** {Boolean}, exhaust have the server send all the documentsxxxxxxx at once as getMore packets.
...
/**
 * Returns an array of documentsxxxxxxx. The caller is responsible for making sure that there
...
/**
 * Iterates over all the documentsxxxxxxx for this cursor. As with **{cursor.toArray}**,
...
Cursor.prototype.nextObject = function(options, callback) {
  ...
  if(self.state == Cursor.INIT) {
    ...
    var commandHandler = function(err, result) {
      ...
      // Add the new documentsxxxxxxx to the list of items, using forloop to avoid
  ...
  try {
    ...
    self.db._executeQueryCommand(getMoreCommand, command_options, function(err, result) {
      ...
      try {
        ...
        // Determine if there's more documentsxxxxxxx to fetch
